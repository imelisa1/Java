...
public class account {
    ...
    public account(){
        ...
        this("Bilgi Yok",0.0,"Bilgi Yok","Bilgi Yok","Bilgi Yok"); // default değer ataması
        //System.out.println("kendi yazdığımız Constructor....");
        // hiçbir değer girilmezse bu method çalışır.
    }
    public account(String hesapNo,double bakiye,String isim,String email,String telefonNo) {
        ...
        //5 değeri de sırasıyla girersek bu çalışır.
    }
    public account(String isim,String email,String telefonNo) { // 5 değerden 3 değer girmek.
